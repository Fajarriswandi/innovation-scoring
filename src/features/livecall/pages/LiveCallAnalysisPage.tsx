...
import { Row, Col, Card, List, Button, Flex } from "antd";
                                ...
                                <Row gutter={16} align="stretch">
                                    ...
                                    <Col xs={24} md={14}>
                                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                                            {/* In call info box */}
                                            <div style={{ gridColumn: "1 / -1", background: "#fff", border: "1px solid #f0f0f0", borderRadius: 12, padding: 16 }}>
                                            ...
                                            {[
                                                { icon: "solar:inbox-unread-bold-duotone", label: "Send follow-up email" },
                                                { icon: "solar:call-incoming-bold-duotone", label: "Transfer call / escalate to supervisor" },
                                                { icon: "solar:document-add-bold-duotone", label: "Create new case / ticket" },
                                                { icon: "solar:calendar-bold-duotone", label: "Schedule callback / meetin" },
                                                { icon: "solar:upload-minimalistic-bold-duotone", label: "Attach document" },
                                                { icon: "solar:magnifer-linear", label: "Search Knowledge Base" },
                                            ].map((qa, idx) => (
                                                <div
                                                    key={idx}
                                                    style={{
                    ...
                    <Row gutter={{ xs: 8, sm: 16, md: 16, lg: 15 }}>
                        <Col xs={24} lg={24} xl={24}>
                            <Card
                                className="cardWithFooter"
                                extra={<a href="#"><Icon icon="material-symbols:refresh-rounded" width={20} height={20} /></a>}
                                title={<span style={{ display: "flex", alignItems: "center", gap: 8 }}><Icon icon="lineicons:gemini" width={20} height={20} color="#40ACE2" />Customer 360 View</span>}
                                style={{ marginBottom: 15 }}
                            >
