...
import SentimentGauge from "@/features/agent/components/SentimentGauge";
        ...
        <Col xs={24} lg={14} xl={16}>
          ...
          <Row gutter={gutter} style={{ marginTop: 15 }}>
            ...
            <Col xs={24} lg={12} xl={12}>
              ...
              <Card extra={<a href="#"> <ReloadOutlined /> </a>} title="Sentiment gauge" style={{ marginBottom: 15, minHeight: "31vh", height: 'auto', paddingBottom: 20 }}>
